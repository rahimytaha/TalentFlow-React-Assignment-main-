  ...
  return (
    <div className="flex flex-col w-full h-full bg-gray-50 relative">
      <header className="flex w-full h-16 bg-white border-b shadow-sm">
        <div className="flex items-center justify-between w-full max-w-screen-xl mx-auto px-20">
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2.5">
              <img className="w-8 h-8" alt="Logo" src="/logo.png" />
              <div className="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent [font-family:'Poppins',Helvetica]">
                TalentFLOW
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              <Input
                className="w-[360px] h-[42px] pl-10 pr-4 [font-family:'Roboto_Mono',Helvetica]"
            ...
            <Button variant="ghost" size="sm" className="h-auto p-2">
              <img className="w-[36.75px] h-7" alt="Button" src="/button.svg" />
            </Button>

            <div className="flex items-center gap-3">
              <Avatar className="w-11 h-11">
                <AvatarImage src="/img-38.png" />
                <AvatarFallback>G</AvatarFallback>
              </Avatar>
              <div className="flex flex-col">
                <div className="text-sm font-medium text-gray-900 [font-family:'Inter',Helvetica]">
                  Google
                </div>
                  ...
                  <Droppable droppableId={stage.id}>
                    {(provided, snapshot) => (
                      <div
                        ...
                        className={`flex-1 space-y-3 overflow-y-auto p-2 rounded-lg transition-colors min-h-[200px] ${
                          ...
                          >
                            {(provided, snapshot) => (
                              <Card
                                ...
                                className={`shadow-sm drag-handle no-select transition-all cursor-grab ${
                                  snapshot.isDragging 
