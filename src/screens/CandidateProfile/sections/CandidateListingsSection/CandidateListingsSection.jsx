                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between mb-2">
                              <div className="flex items-center gap-3">
                                <h3
                                  className={`font-medium text-base [font-family:'Roboto',Helvetica] ${
                              ...
                              <span
                                className={`text-sm [font-family:'Roboto',Helvetica] ${
                                  event.completed || event.current
                                    ? "text-gray-500"
                                    : "text-gray-400"
                                }`}
                            ...
                            <p
                              className={`text-sm mb-3 [font-family:'Roboto',Helvetica] ${
                                event.completed || event.current
                                  ? "text-gray-600"
                                  : "text-gray-400"
                              }`}
